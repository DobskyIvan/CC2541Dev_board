...
#define LL_ADV_NONCONN_INTERVAL_MIN                    32        // 100ms in 625us
...
#define LL_FEATURE_MASK_BYTE2                          (LL_FEATURE_RFU)
#define LL_FEATURE_MASK_BYTE3                          LL_FEATURE_RFU
#define LL_FEATURE_MASK_BYTE4                          LL_FEATURE_RFU
#define LL_FEATURE_MASK_BYTE5                          LL_FEATURE_RFU
#define LL_FEATURE_MASK_BYTE6                          LL_FEATURE_RFU
#define LL_FEATURE_MASK_BYTE7                          LL_FEATURE_RFU

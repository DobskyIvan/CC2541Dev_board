...
void SimpleBLEPeripheral_Init( uint8 task_id )
{
  ...
  // Setup the CyclingPower service Characteristic Values

  uint32 feature = CP_WHEEL_REV_SUPP | CP_ENHA_OFFSET_COMP_SUPP;
  CyclingPower_SetParameter(CP_FEATURE_PARAM, sizeof ( uint32 ), &feature);
